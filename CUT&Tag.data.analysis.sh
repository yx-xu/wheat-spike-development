...
#mapping using bwa
bwa mem -M -t 4 cs.bwa.index clean.SampleName_R1.fq.gz clean.SampleName_R2.fq.gz > SampleName.sam

#filter reads
samtools view -@ 4 -bS -F 1804 -f 2 -q 30 SampleName.sam | samtools sort -@ 4 - -o SampleName.filtered.bam
